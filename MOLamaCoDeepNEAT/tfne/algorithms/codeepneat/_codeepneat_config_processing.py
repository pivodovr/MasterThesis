...
class CoDeepNEATConfigProcessing:
    def _process_config(self):
        ...
        elif self.bp_spec_type == 'gene-overlap-dynamic' or self.bp_spec_type == 'multiobjective':
    ...
    def _sanity_check_config(self):
        ...
        assert self.mod_spec_type == 'basic' or \
               ...
               self.mod_spec_type == 'param-distance-dynamic' or self.mod_spec_type == 'multiobjective'
        if self.mod_spec_type == 'basic':
        ...
        assert self.bp_spec_type == 'basic' or \
               ...
               self.bp_spec_type == 'gene-overlap-dynamic' or \
               self.bp_spec_type == 'multiobjective'
        if self.bp_spec_type == 'basic':
