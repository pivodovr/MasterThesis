...
class EvolutionEngine:
    ...
    def __init__(self,
        ...
        backup_dir_str = backup_dir_str.strftime("backup_%m-%d_%H-%M-%S_")
    ...
    def train(self) -> BaseGenome:
        ...
        while True:
            ...
            generation_counter, best_fitness = self.ne_algorithm.evaluate_population(self.environment,
                                                                                     save_dir_path=self.backup_dir_path)
            ...
            # Evolve population
            population_extinct = self.ne_algorithm.evolve_population(save_dir_path=self.backup_dir_path)
