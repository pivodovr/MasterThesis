...
def lamacodeepneat_mnist_example(_):
    """
    This Example evolves a CoDeepNEAT population on the MNIST handwritten digit dataset for 40 generations. Subsequently
    the best genome is trained for a final 100 epochs and its genotype and Tensorflow model are backed up.
    """
