...
def lamacodeepneat_cifar10_example(_):
    """
    This Example evolves a CoDeepNEAT population on the CIFAR10 dataset for 40 generations. Subsequently the best
    genome is trained for a final 100 epochs and its genotype and Tensorflow model are backed up.
    """
    # Set standard configuration specific to TFNE but not the neuroevolution process
    logging_level = logging.INFO
    config_file_path = './lamacodeepneat_cifar10_short_config.cfg'
...
if __name__ == '__main__':
    app.run(lamacodeepneat_cifar10_example)
