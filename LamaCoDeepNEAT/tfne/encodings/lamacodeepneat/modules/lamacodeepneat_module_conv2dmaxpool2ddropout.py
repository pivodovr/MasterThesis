...
class LamaCoDeepNEATModuleConv2DMaxPool2DDropout(CoDeepNEATModuleConv2DMaxPool2DDropout):
    ...
    an optionally following MaxPooling2D layer and a optionally following Dropout layer.
    ...
    * get_weights
    ...
    def __str__(self) -> str:
        ...
        """
        return "LamaCoDeepNEAT Conv2D MaxPool Dropout Module | ID: {:>6} | Fitness: {:>6} | Filters: {:>4} | " \
