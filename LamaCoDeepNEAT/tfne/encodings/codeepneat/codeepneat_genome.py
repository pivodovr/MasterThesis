...
class CoDeepNEATGenome(BaseGenome,
    ...
    def get_train_err_rate(self):
        return self.train_err_rate

    def set_train_err_rate(self, train_err_rate):
        self.train_err_rate = train_err_rate
