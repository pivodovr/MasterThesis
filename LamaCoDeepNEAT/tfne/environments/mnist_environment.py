...
class MNISTEnvironment(BaseEnvironment):
    ...
    def __init__(self, weight_training, config=None, verbosity=0, lamarck=False, **kwargs):
        ...
        @param lamarck: bool flag indicating, wheter environment is used for lamarckian method (with weight inheritance)
        ...
        if not weight_training:
            ...
            # Set up MNIST environment as weight training and explicitely supplied parameters
            self.eval_genome_fitness = self._eval_genome_fitness_weight_training
