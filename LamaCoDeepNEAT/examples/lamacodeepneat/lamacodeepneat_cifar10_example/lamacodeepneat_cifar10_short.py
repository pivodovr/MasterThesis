...
def lamacodeepneat_cifar10_short(_):
    """
    This Example evolves a LamaCDN population on the CIFAR10 dataset for 40 generations. Subsequently the best
...
if __name__ == '__main__':
    app.run(lamacodeepneat_cifar10_short)
