...
import tfne
from tfne.algorithms.lamacodeepneat import LamaCoDeepNEAT
...
def lamacodeepneat_mnist_example(_):
    """
    This Example evolves a LamaCoDeepNEAT population on the MNIST handwritten digit dataset for 40 generations.
    Subsequently the best genome is trained for a final 100 epochs and its genotype and Tensorflow model are backed up.
    """
    # Set standard configuration specific to TFNE but not the neuroevolution process
    logging_level = logging.INFO
    config_file_path = './lamacodeepneat_mnist_example_config.cfg'
...
if __name__ == '__main__':
    app.run(lamacodeepneat_mnist_example)
